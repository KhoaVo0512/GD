...
function OnToolbarItemClick(s, e) {
    var index = gvGrade.GetFocusedRowIndex();
    ...
    if (e.item.name == "AdminDataGrade") {
        PopupControlFilterGrade.Show();
    }
...
function CFInitGridview(s, e) {
    gvGrade.PerformCallback({ active: activeValue });
}

function onSubmitClickFilterGrade(s, e) {
    PopupControlFilterGrade.Hide();
}
